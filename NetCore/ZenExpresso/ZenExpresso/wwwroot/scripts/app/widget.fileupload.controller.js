(function ($,hljs) {
    ...
    angular
        .module('app')
        .controller('FileUploadWidgetController', FileUploadWidgetController);
    FileUploadWidgetController.$inject = ['brudexservices', 'brudexutils', '$window', 'DataHolder','$scope'];
    function FileUploadWidgetController(services, utils, $window, DataHolder, $scope) {
        var vm = this;
        var _ = utils._;
        vm.errorMsg = [];
        vm.rowAction = {};
