...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("sql",function(){"use strict";return function(e){
...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}}());hljs.registerLanguage("typescript",function(){"use strict"
...
name:"TypeScript",aliases:["ts"]}),g}}());hljs.registerLanguage("csharp",function(){"use strict";return function(e){
var n={
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}}());hljs.registerLanguage("json",function(){"use strict";return function(n){var e={
...
name:"JSON",contains:t,keywords:e,illegal:"\\S"}}}());hljs.registerLanguage("bash",function(){"use strict";return function(e){
