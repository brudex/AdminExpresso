        ...
        function executeResult() {
            if (vm.taskInfo) {
                ...
                for (var k = 0, len = flowData.formControls.length; k < len; k++) {
                    ...
                    if (control.fieldType !== 'readonly' && control.fieldType !== 'imageview' && control.fieldType !== 'separator') {
        ...
        function buildSelectOptions(selectOptionsDatasource) {
            ...
            function buildDropSelectOptions(array) {
                ...
                array.forEach(function(obj) {
                    ...
                    if (labelfield === "" && keyfield !== "") {
                        var filter = props.filter(x => { return x !== keyfield });
                        if (filter.length) {
                            labelfield = filter[0];
                        }
                    }
