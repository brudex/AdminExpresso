...
namespace ZenExpressoCore.Models
{
    public class DedicatedAdmin
    {
        ...
        public bool canManageUserRoles{ get; set; } //can assign tasks/roles to users
        ...
        {
            return canCreateUser || canCreateTask || canManageLogs || canCreateAdmin || canManageUserRoles;
        }
